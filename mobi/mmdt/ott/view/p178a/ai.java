...
/* renamed from: mobi.mmdt.ott.view.a.ai */
public class ai {
    private static Bitmap m8471a(Bitmap bitmap, int i, int i2) {
    ...
    public static Bitmap m8472a(Bitmap bitmap, int i, int i2, int i3, boolean z) {
        return ai.m8473a(ai.m8471a(bitmap, i, i2), i3, z);
    }

    public static Bitmap m8473a(Bitmap bitmap, int i, boolean z) {
        Bitmap bitmap2;
        if (z) {
            bitmap2 = bitmap;
        } else {
