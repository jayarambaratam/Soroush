...
/* renamed from: mobi.mmdt.ott.c.a.b.b.ae */
public class ae extends ai {
    C1263m f4433a;

    public ae(C1263m c1263m) {
        this.f4433a = c1263m;
    }

    public C1195v m6728a(JSONObject jSONObject) {
        ...
        C1195v adVar = new ad(jSONObject.getString("ResultCode"), jSONObject.getString("ResultMessage"), arrayList);
        adVar.m6614b(false);
        return adVar;
    }
}
