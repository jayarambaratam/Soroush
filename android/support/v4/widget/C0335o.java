...
public abstract class C0335o extends BaseAdapter implements C0334t, Filterable {
    @Deprecated
    public static final int FLAG_AUTO_REQUERY = 1;
    public static final int FLAG_REGISTER_CONTENT_OBSERVER = 2;
    protected boolean mAutoRequery;
    protected C0349q mChangeObserver;
    protected Context mContext;
    protected Cursor mCursor;
    protected C0351s mCursorFilter;
    ...
    @Deprecated
    public C0335o(Context context, Cursor cursor) {
        init(context, cursor, (int) FLAG_AUTO_REQUERY);
    }

    public C0335o(Context context, Cursor cursor, int i) {
        init(context, cursor, i);
    }

    public C0335o(Context context, Cursor cursor, boolean z) {
    ...
    public Filter getFilter() {
        if (this.mCursorFilter == null) {
            this.mCursorFilter = new C0351s(this);
        }
    ...
    void init(Context context, Cursor cursor, int i) {
        ...
        if ((i & FLAG_REGISTER_CONTENT_OBSERVER) == FLAG_REGISTER_CONTENT_OBSERVER) {
            this.mChangeObserver = new C0349q(this);
            this.mDataSetObserver = new C0350r();
        } else {
