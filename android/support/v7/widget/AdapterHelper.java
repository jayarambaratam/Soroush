...
class AdapterHelper implements Callback {
    ...
    private C0237o<UpdateOp> mUpdateOpPool;
    ...
    AdapterHelper(Callback callback, boolean z) {
        this.mUpdateOpPool = new C0238p(30);
    ...
    public UpdateOp obtainUpdateOp(int i, int i2, int i3, Object obj) {
        UpdateOp updateOp = (UpdateOp) this.mUpdateOpPool.m1719a();
        if (updateOp == null) {
    ...
    boolean onItemRangeChanged(int i, int i2, Object obj) {
        ...
        return this.mPendingUpdates.size() == POSITION_TYPE_NEW_OR_LAID_OUT ? true : DEBUG;
    }
    ...
    public void recycleUpdateOp(UpdateOp updateOp) {
        if (!this.mDisableRecycler) {
            ...
            this.mUpdateOpPool.m1720a(updateOp);
        }
    }
