...
public class ActionBarContextView extends AbsActionBarView {
    ...
    class C04601 implements OnClickListener {
        final /* synthetic */ C0378b val$mode;

        C04601(C0378b c0378b) {
            this.val$mode = c0378b;
        }

        public void onClick(View view) {
            this.val$mode.m3768c();
        }
    }
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0359b.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0369l.ActionMode, i, 0);
        setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0369l.ActionMode_background));
        this.mTitleStyleRes = obtainStyledAttributes.getResourceId(C0369l.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = obtainStyledAttributes.getResourceId(C0369l.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = obtainStyledAttributes.getLayoutDimension(C0369l.ActionMode_height, 0);
        this.mCloseItemLayout = obtainStyledAttributes.getResourceId(C0369l.ActionMode_closeItemLayout, C0366i.abc_action_mode_close_item_material);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0366i.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0364g.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0364g.action_bar_subtitle);
    ...
    public void initForMode(C0378b c0378b) {
        if (this.mClose == null) {
        ...
        this.mClose.findViewById(C0364g.action_mode_close_button).setOnClickListener(new C04601(c0378b));
        C0049i c0049i = (C0049i) c0378b.m3765b();
        ...
        c0049i.m104a(this.mActionMenuPresenter, this.mPopupContext);
    ...
    public /* bridge */ /* synthetic */ el setupAnimatorToVisibility(int i, long j) {
