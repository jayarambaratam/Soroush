...
public class SlideInDownAnimator extends BaseItemAnimator {
    ...
    protected void animateRemoveImpl(ViewHolder viewHolder) {
        cb.m2442s(viewHolder.itemView).m2806c((float) (-viewHolder.itemView.getHeight())).m2798a(0.0f).m2799a(getRemoveDuration()).m2800a(new DefaultRemoveVpaListener(viewHolder)).m2807c();
    }

    protected void preAnimateAddImpl(ViewHolder viewHolder) {
        cb.m2408b(viewHolder.itemView, (float) (-viewHolder.itemView.getHeight()));
