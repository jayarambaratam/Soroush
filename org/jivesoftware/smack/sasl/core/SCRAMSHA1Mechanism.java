...
public class SCRAMSHA1Mechanism extends SASLMechanism {
    private static final C2634a<String, Keys> CACHE;
    ...
    /* synthetic */ class C26831 {
        static final /* synthetic */ int[] f8407x569b47df;

        static {
            f8407x569b47df = new int[State.values().length];
            try {
                f8407x569b47df[State.AUTH_TEXT_SENT.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f8407x569b47df[State.RESPONSE_SENT.ordinal()] = 2;
    ...
    protected byte[] evaluateChallenge(byte[] bArr) {
        ...
        switch (C26831.f8407x569b47df[this.state.ordinal()]) {
    ...
    public int getPriority() {
        return C1317h.Theme_RoundAvatarImageViewStyle;
    }
