...
public class XMPPTCPConnection extends AbstractXMPPConnection {
    ...
    class C26861 extends AbstractConnectionListener {
        C26861() {
        }
    ...
    class C26872 implements Runnable {
    ...
    class C26883 implements Runnable {
    ...
    public class PacketReader {
        ...
        class C26891 implements Runnable {
            C26891() {
            }
        ...
        L_0x0331:
            ...
            r5 = new java.util.LinkedList;	 Catch:{ Exception -> 0x004d }
            r5.<init>();	 Catch:{ Exception -> 0x004d }
            r0 = org.jivesoftware.smack.tcp.XMPPTCPConnection.this;	 Catch:{ Exception -> 0x004d }
            r0 = r0.unacknowledgedStanzas;	 Catch:{ Exception -> 0x004d }
            r5.addAll(r0);	 Catch:{ Exception -> 0x004d }
        ...
        L_0x0352:
            ...
            r7 = r7.packetWriter;	 Catch:{ Exception -> 0x004d }
            r7.sendStreamElement(r0);	 Catch:{ Exception -> 0x004d }
            goto L_0x034c;
        L_0x0360:
            r0 = org.jivesoftware.smack.tcp.XMPPTCPConnection.this;	 Catch:{ Exception -> 0x004d }
        ...
        void init() {
            this.done = false;
            Async.go(new C26891(), "Smack Packet Reader (" + XMPPTCPConnection.this.getConnectionCounter() + ")");
        }
    ...
    public class PacketWriter {
        ...
        class C26901 implements Runnable {
            C26901() {
            }
        ...
        void init() {
            ...
            this.queue.start();
            Async.go(new C26901(), "Smack Packet Writer (" + XMPPTCPConnection.this.getConnectionCounter() + ")");
        }
    ...
    public XMPPTCPConnection(CharSequence charSequence, String str) {
        this(C2643e.m11080a(charSequence.toString()), str, C2643e.m11083b(charSequence.toString()));
    }
    ...
    public XMPPTCPConnection(XMPPTCPConnectionConfiguration xMPPTCPConnectionConfiguration) {
        ...
        addConnectionListener(new C26861());
    }
    ...
    private void processHandledCount(long j) {
        ...
        List<Stanza> arrayList = new ArrayList(j <= 2147483647L ? (int) j : ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    ...
    public StanzaListener addStanzaIdAcknowledgedListener(String str, StanzaListener stanzaListener) {
        if (this.smWasEnabledAtLeastOnce) {
            schedule(new C26872(str), (long) Math.min(getMaxSmResumptionTime(), 43200), TimeUnit.SECONDS);
    ...
    public int getMaxSmResumptionTime() {
        ...
        int i2 = this.smClientMaxResumptionTime > 0 ? this.smClientMaxResumptionTime : ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
    ...
    void openStream() {
        ...
        if (username != null) {
            charSequence = C2643e.m11079a(username, serviceName);
        }
