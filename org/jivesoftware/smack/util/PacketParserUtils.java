...
public class PacketParserUtils {
            ...
            while (true) {
                switch (xmlPullParser.next()) {
                    case VideoSize.HVGA /*2*/:
                        ...
                        defaultExtensionElement.setValue(name, BuildConfig.FLAVOR);
                        break;
                    case Version.API03_CUPCAKE_15 /*3*/:
    ...
    public static IQ parseIQ(XmlPullParser xmlPullParser) {
        ...
        String attributeValue2 = xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, PrivacyItem.SUBSCRIPTION_TO);
        String attributeValue3 = xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, PrivacyItem.SUBSCRIPTION_FROM);
        ...
        while (true) {
            switch (xmlPullParser.next()) {
                ...
                case Version.API03_CUPCAKE_15 /*3*/:
                    ...
                    if (iq == null) {
                        switch (C26961.$SwitchMap$org$jivesoftware$smack$packet$IQ$Type[fromString.ordinal()]) {
    ...
    public static Message parseMessage(XmlPullParser xmlPullParser) {
        ...
        if ($assertionsDisabled || xmlPullParser.getName().equals(Message.ELEMENT)) {
            ...
            message.setStanzaId(xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "id"));
            message.setTo(xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, PrivacyItem.SUBSCRIPTION_TO));
            message.setFrom(xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, PrivacyItem.SUBSCRIPTION_FROM));
            ...
            if (attributeValue == null || BuildConfig.FLAVOR.equals(attributeValue.trim())) {
    ...
    public static Presence parsePresence(XmlPullParser xmlPullParser) {
        ...
        presence.setTo(xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, PrivacyItem.SUBSCRIPTION_TO));
        presence.setFrom(xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, PrivacyItem.SUBSCRIPTION_FROM));
        presence.setStanzaId(xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "id"));
        String languageAttribute = getLanguageAttribute(xmlPullParser);
        if (!(languageAttribute == null || BuildConfig.FLAVOR.equals(languageAttribute.trim()))) {
