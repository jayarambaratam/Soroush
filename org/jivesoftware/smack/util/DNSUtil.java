...
public class DNSUtil {
    ...
    final class C26921 implements StringTransformer {
        C26921() {
        }
    ...
    private static List<HostAddress> resolveDomain(String str, DomainType domainType, List<HostAddress> list) {
        ...
        switch (C26932.$SwitchMap$org$jivesoftware$smack$util$DNSUtil$DomainType[domainType.ordinal()]) {
