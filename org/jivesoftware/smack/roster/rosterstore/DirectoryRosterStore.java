...
public class DirectoryRosterStore implements RosterStore {
    ...
    final class C26821 implements FileFilter {
        C26821() {
        }
    ...
    public static DirectoryRosterStore init(File file) {
        ...
        return directoryRosterStore.setRosterVersion(BuildConfig.FLAVOR) ? directoryRosterStore : null;
    }
