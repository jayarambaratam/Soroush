...
public class ReconnectionManager {
    ...
    final class C26591 implements ConnectionCreationListener {
        C26591() {
        }
    ...
    class C26602 extends Thread {
        ...
        private int timeDelay() {
            this.attempts++;
            switch (C26624.f8403x55bc48cf[ReconnectionManager.this.reconnectionPolicy.ordinal()]) {
    ...
    class C26613 extends AbstractConnectionListener {
        C26613() {
        }
    ...
    /* synthetic */ class C26624 {
        static final /* synthetic */ int[] f8403x55bc48cf;

        static {
            f8403x55bc48cf = new int[ReconnectionPolicy.values().length];
            try {
                f8403x55bc48cf[ReconnectionPolicy.FIXED_DELAY.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f8403x55bc48cf[ReconnectionPolicy.RANDOM_INCREASING_DELAY.ordinal()] = 2;
    ...
    static {
        ...
        XMPPConnectionRegistry.addConnectionCreationListener(new C26591());
    ...
    private ReconnectionManager(AbstractXMPPConnection abstractXMPPConnection) {
        ...
        this.done = false;
        this.connectionListener = new C26613();
        this.weakRefConnection = new WeakReference(abstractXMPPConnection);
        this.reconnectionRunnable = new C26602();
