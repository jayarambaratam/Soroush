...
public class VersionManager extends Manager {
    ...
    final class C27461 implements ConnectionCreationListener {
        C27461() {
        }
    ...
    class C27472 extends AbstractIqRequestHandler {
        C27472(String str, String str2, Type type, Mode mode) {
    ...
    static {
        ...
        XMPPConnectionRegistry.addConnectionCreationListener(new C27461());
    }
    ...
    private VersionManager(XMPPConnection xMPPConnection) {
        ...
        xMPPConnection.registerIQRequestHandler(new C27472(UserSearch.ELEMENT, Version.NAMESPACE, Type.get, Mode.async));
    }
