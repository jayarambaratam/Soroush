...
public class ServerPingWithAlarmManager extends Manager {
    ...
    final class C27641 implements ConnectionCreationListener {
        C27641() {
        }
    ...
    final class C27662 extends BroadcastReceiver {
        ...
        class C27651 implements Runnable {
            ...
            C27651(PingManager pingManager) {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            for (Entry entry : hashSet) {
                ...
                if (((ServerPingWithAlarmManager) entry.getValue()).isEnabled()) {
                    ...
                    Async.go(new C27651(PingManager.getInstanceFor(xMPPConnection)), "PingServerIfNecessary (" + xMPPConnection.getConnectionCounter() + ')');
                } else {
    ...
    static {
        ...
        XMPPConnectionRegistry.addConnectionCreationListener(new C27641());
        ALARM_BROADCAST_RECEIVER = new C27662();
    }
