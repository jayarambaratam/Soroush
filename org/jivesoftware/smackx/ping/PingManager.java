...
public class PingManager extends Manager {
    ...
    final class C27601 implements ConnectionCreationListener {
        C27601() {
        }
    ...
    class C27612 extends AbstractIqRequestHandler {
        C27612(String str, String str2, Type type, Mode mode) {
    ...
    class C27623 extends AbstractConnectionClosedListener {
        C27623() {
        }
    ...
    class C27634 implements Runnable {
        C27634() {
        }
    ...
    static {
        ...
        XMPPConnectionRegistry.addConnectionCreationListener(new C27601());
    ...
    private PingManager(XMPPConnection xMPPConnection) {
        ...
        this.pingServerRunnable = new C27634();
        ...
        xMPPConnection.registerIQRequestHandler(new C27612(Ping.ELEMENT, Ping.NAMESPACE, Type.get, Mode.async));
        xMPPConnection.addConnectionListener(new C27623());
