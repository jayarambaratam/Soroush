...
public class InBandBytestreamManager implements BytestreamManager {
    ...
    final class C27031 implements ConnectionCreationListener {

        /* renamed from: org.jivesoftware.smackx.bytestreams.ibb.InBandBytestreamManager.1.1 */
        class C27021 extends AbstractConnectionClosedListener {
            final /* synthetic */ XMPPConnection val$connection;

            C27021(XMPPConnection xMPPConnection) {
        ...
        public void connectionCreated(XMPPConnection xMPPConnection) {
            ...
            xMPPConnection.addConnectionListener(new C27021(xMPPConnection));
        }
    }
    ...
    static {
        XMPPConnectionRegistry.addConnectionCreationListener(new C27031());
    ...
    private InBandBytestreamManager(XMPPConnection xMPPConnection) {
        ...
        this.defaultBlockSize = ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT;
