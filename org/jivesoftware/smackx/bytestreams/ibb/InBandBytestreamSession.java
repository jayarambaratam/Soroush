...
public class InBandBytestreamSession implements BytestreamSession {
    ...
    /* synthetic */ class C27041 {
        static final /* synthetic */ int[] f8409xda8e09c8;

        static {
            f8409xda8e09c8 = new int[StanzaType.values().length];
            try {
                f8409xda8e09c8[StanzaType.IQ.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f8409xda8e09c8[StanzaType.MESSAGE.ordinal()] = 2;
    ...
    class IQIBBInputStream extends IBBInputStream {
        ...
        class C27051 implements StanzaListener {
    ...
    class MessageIBBInputStream extends IBBInputStream {
        ...
        class C27061 implements StanzaListener {
            C27061() {
            }
    ...
    protected InBandBytestreamSession(XMPPConnection xMPPConnection, Open open, String str) {
        ...
        this.remoteJID = str;
        switch (C27041.f8409xda8e09c8[open.getStanza().ordinal()]) {
