...
public class Bookmarks implements PrivateData {
    ...
    private static BookmarkedConference getConferenceStorage(XmlPullParser xmlPullParser) {
        ...
        String attributeValue2 = xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "autojoin");
        BookmarkedConference bookmarkedConference = new BookmarkedConference(xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "jid"));
    ...
    private static BookmarkedURL getURLStorage(XmlPullParser xmlPullParser) {
        String attributeValue = xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "name");
        String attributeValue2 = xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "url");
        String attributeValue3 = xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "rss");
