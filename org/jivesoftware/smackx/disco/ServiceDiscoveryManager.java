...
public class ServiceDiscoveryManager extends Manager {
    ...
    private C2634a<String, List<String>> services;

    /* renamed from: org.jivesoftware.smackx.disco.ServiceDiscoveryManager.1 */
    final class C27281 implements ConnectionCreationListener {
        C27281() {
        }
    ...
    class C27292 extends AbstractIqRequestHandler {
        C27292(String str, String str2, Type type, Mode mode) {
    ...
    class C27303 extends AbstractIqRequestHandler {
        C27303(String str, String str2, Type type, Mode mode) {
            super(str, str2, type, mode);
        }
    ...
    static {
        ...
        XMPPConnectionRegistry.addConnectionCreationListener(new C27281());
    }
    ...
    private ServiceDiscoveryManager(XMPPConnection xMPPConnection) {
        ...
        this.services = new C2635b(25, 86400000);
        addFeature(DiscoverInfo.NAMESPACE);
        addFeature(DiscoverItems.NAMESPACE);
        xMPPConnection.registerIQRequestHandler(new C27292(UserSearch.ELEMENT, DiscoverItems.NAMESPACE, Type.get, Mode.async));
        xMPPConnection.registerIQRequestHandler(new C27303(UserSearch.ELEMENT, DiscoverInfo.NAMESPACE, Type.get, Mode.async));
    }
