...
public class AdHocCommandDataProvider extends IQProvider<AdHocCommandData> {
    ...
    public AdHocCommandData parse(XmlPullParser xmlPullParser, int i) {
        ...
        adHocCommandData.setSessionID(xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "sessionid"));
        adHocCommandData.setNode(xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "node"));
        String attributeValue2 = xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, Status.ELEMENT);
        ...
        attributeValue2 = xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, Action.ATTRIBUTE_NAME);
                ...
                while (obj == null) {
                    ...
                    if (next != 2) {
                        if (xmlPullParser.getName().equals("actions")) {
                            attributeValue = xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "execute");
                            ...
                            adHocCommandData.addNote(new AdHocCommandNote(Type.valueOf(xmlPullParser.getAttributeValue(BuildConfig.FLAVOR, "type")), xmlPullParser.nextText()));
