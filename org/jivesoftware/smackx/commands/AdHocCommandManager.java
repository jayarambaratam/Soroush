...
public class AdHocCommandManager extends Manager {
    ...
    final class C27221 implements ConnectionCreationListener {
        C27221() {
        }
    ...
    class C27232 extends AbstractNodeInformationProvider {
        C27232() {
        }
    ...
    class C27243 extends AbstractIqRequestHandler {
        C27243(String str, String str2, Type type, Mode mode) {
    ...
    class C27254 implements LocalCommandFactory {
    ...
    class C27265 extends AbstractNodeInformationProvider {
    ...
    class C27276 implements Runnable {
        C27276() {
        }
    ...
    static {
        ...
        XMPPConnectionRegistry.addConnectionCreationListener(new C27221());
    }
    ...
    private AdHocCommandManager(XMPPConnection xMPPConnection) {
        ...
        ServiceDiscoveryManager.getInstanceFor(xMPPConnection).setNodeInformationProvider(NAMESPACE, new C27232());
        xMPPConnection.registerIQRequestHandler(new C27243(AdHocCommandData.ELEMENT, NAMESPACE, Type.set, Mode.async));
            ...
            try {
                ...
                if (localCommand.isLastStage()) {
                    ...
                    if (this.sessionsSweeper == null) {
                        this.sessionsSweeper = new Thread(new C27276());
    ...
    public void registerCommand(String str, String str2, Class<? extends LocalCommand> cls) {
        registerCommand(str, str2, new C27254(cls));
    }
    ...
    public void registerCommand(String str, String str2, LocalCommandFactory localCommandFactory) {
        ...
        this.serviceDiscoveryManager.setNodeInformationProvider(str, new C27265(str2));
    }
}
