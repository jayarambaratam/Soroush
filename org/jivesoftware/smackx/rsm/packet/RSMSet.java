...
public class RSMSet implements ExtensionElement {
    ...
    /* synthetic */ class C27801 {
        static final /* synthetic */ int[] f8411x47d3bd1a;

        static {
            f8411x47d3bd1a = new int[PageDirection.values().length];
            try {
                f8411x47d3bd1a[PageDirection.before.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f8411x47d3bd1a[PageDirection.after.ordinal()] = 2;
    ...
    public RSMSet(int i, String str, PageDirection pageDirection) {
        switch (C27801.f8411x47d3bd1a[pageDirection.ordinal()]) {
